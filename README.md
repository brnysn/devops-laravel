...
### Provisioning
1. Update the server options in [`config.yml`](./config.yml) (PHP version, database root password, optional services such as Reverb / Typesense, and any additional node IPs in `servers`).
